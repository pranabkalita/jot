...
@section('content')
    <div class="bg-gray-300 mx-auto h-full flex justify-center items-center">
        <div class="w-96 p-6 rounded-lg bg-blue-900 shadow-xl">
            ...
            <h1 class="text-white text-3xl pt-6">Join Us</h1>
            ...
            <form method="POST" action="{{ route('register') }}" class="pt-6">
                ...
                <div class="relative">
                    ...
                    <input id="name" type="text" class="w-full p-3 pt-6 rounded focus:outline-none focus:bg-blue-700 bg-blue-800 text-gray-100 @error('name') border border-red-600 @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Your Name">
                ...
                <div class="relative pt-3">
                    ...
                    <input id="email" type="email" class="w-full p-3 pt-6 rounded focus:outline-none focus:bg-blue-700 bg-blue-800 text-gray-100 @error('email') border border-red-600 @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="your@email.com">
                ...
                <div class="relative pt-3">
                    ...
                    <input id="password" type="password" class="w-full p-3 pt-6 rounded focus:outline-none focus:bg-blue-700 bg-blue-800 text-gray-100 @error('password') border border-red-600 @enderror" name="password" required autocomplete="current-password" placeholder="Password">
                ...
                <div class="relative pt-3">
                    ...
                    <input id="password-confirm" type="password" class="w-full p-3 pt-6 rounded focus:outline-none focus:bg-blue-700 bg-blue-800 text-gray-100" name="password_confirmation" required placeholder="Confirm">
                </div>
