...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <h1 class="text-white text-3xl pt-6">Oh no!</h1>
        ...
        <div class="pt-6">
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <div class="relative">
                    ...
                    <div class="col-md-6">
                        <input
                            id="email"
                            type="email"
                            class="pt-6 w-full p-3 rounded bg-blue-800 text-green-100 outline-none focus:bg-blue-700"
                            name="email"
                ...
                <div class="pt-6">
                    <button type="submit" class="w-full bg-gray-400 uppercase rounded text-left text-gray-100 text-blue-800 font-bold py-2 px-3">
                        Send Reset Email
                    </button>
                </div>
